...
const AppRoutes: React.FC = () => (
  <Routes>
    ...
    <Route path="/main" element={<GlobalLayout />}>
      ...
      <Route path="insurance/:insuranceId" element={<InsuranceDetailPage />} />
      ...
      <Route path="claims/" element={<ClaimsListPage />} /> {/* 보험 선택 */}
      <Route path=":memberId/claims" element={<ClaimsListPage />} /> {/* 보험 선택 */}
      <Route path="claims/:claimId" element={<ClaimDetailPage />} /> {/* 보험 선택 */}
